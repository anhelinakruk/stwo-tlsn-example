...
mod tests {
    ...
    fn test_blake_double_bridge_prove_verify() {
        ...
        let bridge_trace = gen_bridge_trace(log_size, input.clone(), num_consumers);

        let double_trace = gen_double_trace(log_size, input);
        ...
        let input_elements = InputRelation::draw(prover_channel);
        ...
        println!("Blake3 XOR interaction traces generated");
        ...
        println!("Blake3 XOR4 claimed:          {:?}", blake_xor_claimed_sum4);

        let blake3_internal_sum = blake_scheduler_claimed_sum
            + rounds_sum
            + blake_xor_claimed_sum12
        ...
        let total_sum = bridge_claimed_sum
            + double_claimed_sum
            + blake_scheduler_claimed_sum
            + rounds_sum
            + blake_xor_claimed_sum12
        ...
        tree_builder.extend_evals(double_interaction_trace);
        ...
        let bridge_component = InputBridgeComponent::new(
        ...
        let double_sizes = double_component.trace_log_degree_bounds();
